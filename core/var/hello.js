...
const prd_Hello = () => {
  ...
  const prd_Message= gradient.rainbow(`◆━━━━━━━━━━━━◆◆━━━━━━━━━━━━◆◆━━━━━━━━━━━━◆\n[ Para - Time ] -> Hiện tại bây giờ là ${currentHour}:${currentMinute}:${currentSecond} | ${dayOfWeek} || ${date}\n`) +
    gradient.fruit('[ Para - Bot ] -> Độ ảo war của các mày đã lên 1 tầm cao mới\n◆━━━━━━━━━━━━◆◆━━━━━━━━━━━━◆◆━━━━━━━━━━━━◆');
